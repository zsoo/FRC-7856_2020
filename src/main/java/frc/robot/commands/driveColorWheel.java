...
public class driveColorWheel extends Command {
  public driveColorWheel() {
  ...
  protected void execute() {
    ...
    Robot.m_color.DriveCartesian(ySpeed, xSpeed, zRotation);
  ...
  @Override
  protected void end() {
    Robot.m_color.DriveCartesian(0, 0, 0);
  }
